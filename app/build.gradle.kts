...
android {
    namespace = "net.mustafaer.quickqr"
    compileSdk = 36
    ...
    buildTypes {
        debug {
            // Lets a debug build sit alongside the Play release on the same device.
...
ksp {
    // Room schema history, committed so migrations can be written and verified against it.
